...
export const coursesData: Course[] = [
  ...
  },
  {
    ...
    description: {
      text: "Подходит для специалистов, прошедших курс UniBrace ступень 1\nОбучение в мини-группе до 5 человек\nДлительность курса: 5-6 часов",
...
Длительность: 8–10 часов (2 дня)
Формат: Интерактивный вебинар`,
      image: "/images/school/course-ingrown1.png"
    },
    plan: {
      hasPlan: true,
